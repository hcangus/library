...
import net.hcangus.pickerview.listener.OnDismissListener;
import net.hcangus.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            //设置对话框 左右间距屏幕30
            this.params.leftMargin = 90;
            this.params.rightMargin = 90;
    ...
    private void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.style_custom_dialog);
