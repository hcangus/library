...
import net.hcangus.pickerview.listener.CustomListener;
import net.hcangus.pickerview.view.BasePickerView;
import net.hcangus.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
	...
	public void returnData(View v) {
		if (timeSelectListener != null) {
			Date date = new Date(wheelTime.getTime());
