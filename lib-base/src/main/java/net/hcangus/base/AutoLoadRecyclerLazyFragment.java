...
/**
 * 适用于要自动加载的{@link AutoLoadRecyclerView}
 * 的{@link LazyFragment}基类
 * <p>注意将布局中{@link AutoLoadRecyclerView}的<em> id </em>
 * 设置为<em> R.id.autoload_recyclerView</em>
 *
 * 如果外层包含了{@link PtrFrameLayout},id设置为：R.id.ptrFrame，
 * 调用{@link #onRefresh()}即可
 *
 * @param <E> List中数据的类型
 *            <p>Created by hcangus
 */

public abstract class AutoLoadRecyclerLazyFragment<E, V extends View_PtrList<E>>
	...
	protected void initView(View view, Bundle savedInstanceState) {
		...
		autoLoadRecyclerView.setAutoLoadListener(new AutoLoadListener() {
			...
			public void onErrorClick() {
				AutoLoadRecyclerLazyFragment.this.onErrorClick();
			}
		});
	}
