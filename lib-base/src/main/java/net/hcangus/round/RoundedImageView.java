...
public class RoundedImageView extends AppCompatImageView {
	...
	/**
	 * Set all the corner radii from a dimension resource user_id.
	 *
	 * @param resId dimension resource user_id of radii.
	 */
	...
	/**
	 * Set the corner radius of a specific corner from a dimension resource user_id.
	 *
	 * @param corner the corner to set.
	 * @param resId  the dimension resource user_id of the corner radius.
	 */
