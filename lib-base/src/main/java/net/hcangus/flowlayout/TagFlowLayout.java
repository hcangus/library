...
public class TagFlowLayout<E> extends FlowLayout implements TagAdapter.OnDataChangedListener {
	private TagAdapter<E> mTagAdapter;
	...
	public void setAdapter(TagAdapter<E> adapter) {
		mTagAdapter = adapter;
	...
	private void changeAdapter() {
		removeAllViews();
		TagAdapter<E> adapter = mTagAdapter;
	...
	public TagAdapter<E> getAdapter() {
		return mTagAdapter;
	}
